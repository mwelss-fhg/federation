...
public class MapBuilder<K, V> {
	...
	/*
	 * If theEntries contains multiple entries with the same key then the key gets a
	 * suffix in order to make it unique ..
	 */
	// public MapBuilder forceAll(final Iterable<? extends Map.Entry<? extends K, ?
	// extends V>> theEntries,
